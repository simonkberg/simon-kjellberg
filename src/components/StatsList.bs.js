              ...
              return ReasonReact.element(undefined, undefined, Curry.app(WakaTimeStatsQuery[/* make */3], [
                              ...
                              (function (param) {
                                  ...
                                  if (typeof result === "number") {
                                    return ReasonReact.element(undefined, undefined, Loader$SimonKjellberg.make(/* array */[]));
                                  } else if (result.tag) {
                                    ...
                                    if (response.wakaTime.stats.length === 0) {
                                      ...
                                      return ReasonReact.element(undefined, undefined, UnorderedList$SimonKjellberg.make(undefined, undefined, /* array */[ReasonReact.element(undefined, undefined, make(response.wakaTime.stats, /* array */[]))]));
                                    }
                                  } else {
